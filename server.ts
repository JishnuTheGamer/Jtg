...
import { attachContainerSocket } from "./src/server/services/docker.js";
...
io.on("connection", (socket) => {
  socket.on("joinServer", async (serverId) => {
    ...
    // Historical logs are loaded through /api/servers/:id/logs. The socket only
    // attaches the live stream to avoid replaying the same startup output.
    try {
